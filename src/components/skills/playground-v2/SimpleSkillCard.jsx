...
export default function SimpleSkillCard({ skill, categoryLabel, cardRef }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-white/[0.02] border border-white/[0.03] text-zinc-400 group-hover:text-[#e9b15d] group-hover:border-[#e9b15d]/20 transition-all duration-300 transform group-hover:scale-1.08 shrink-0">
