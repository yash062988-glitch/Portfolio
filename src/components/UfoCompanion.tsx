...
export default function UfoCompanion() {
  ...
  const engineGlowShadow = `drop-shadow(0 ${shadowY}px ${shadowBlur}px rgba(251,191,36,${shadowOpacity}))`;
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      for (const p of particles.current) {
        ...
        grad.addColorStop(0, `hsla(${p.hue},100%,78%,${alpha})`);
        grad.addColorStop(1, `hsla(${p.hue},100%,52%,0)`);
        ctx.beginPath();
            ...
            >
              <defs>
                <radialGradient id="engineGlow" cx="50%" cy="40%" r="50%">
                  <stop offset="0%" stopColor="#ffd060" stopOpacity={0.95 + glowIntensity * 0.05} />
                  <stop offset="40%" stopColor="#f59e0b" stopOpacity={0.7 + glowIntensity * 0.3} />
                  <stop offset="100%" stopColor="#b45309" stopOpacity="0" />
                </radialGradient>

                <radialGradient id="engineHalo" cx="50%" cy="50%" r="50%">
                  <stop offset="0%" stopColor="#fbbf24" stopOpacity={0.3 + glowIntensity * 0.55} />
              ...
              <ellipse cx="70" cy="83" rx="10" ry="3.5" fill="#fde68a" opacity={0.6 + glowIntensity * 0.4} />
              ...
              <ellipse cx="70" cy="78" rx="44" ry="9.5" fill="none" stroke="#c8962a" strokeWidth="0.6" opacity="0.45" />
              ...
              {portholes.map((p, i) => (
                <g key={i}>
                  ...
                  <circle cx={p.x} cy={p.y} r={3} fill="#1a1a28" stroke="#c8962a" strokeWidth="0.8" />
                  <circle cx={p.x} cy={p.y} r={1.9} fill="#fde68a" opacity="0.92" />
